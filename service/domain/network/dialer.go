...
type ClientPeerInitializer interface {
	InitializeClientPeer(rwc io.ReadWriteCloser, remote identity.Public) (transport.Peer, error)
}
...
func (d Dialer) DialWithInitializer(initializer ClientPeerInitializer, remote identity.Public, addr Address) (transport.Peer, error) {
...
func (d Dialer) Dial(remote identity.Public, address Address) (transport.Peer, error) {
