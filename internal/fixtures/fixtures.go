...
func TestLogger(tb testing.TB) logging.Logger {
	system := logging.NewTestingLoggingSystem(tb)
	return logging.NewContextLogger(system, "test")
}
...
type testingLoggerSystem struct {
	name string
	t    testing.TB
	log  func(args ...any)
}

func (t testingLoggerSystem) Error() logging.LoggingSystemEntry {
	//TODO implement me
	panic("implement me")
}

func (t testingLoggerSystem) Debug() logging.LoggingSystemEntry {
	//TODO implement me
	panic("implement me")
}

func (t testingLoggerSystem) Trace() logging.LoggingSystemEntry {
	//TODO implement me
	panic("implement me")
}
...
//}
//
//func (t testingLogger) Error() logging.Entry {
//}
//
//func (t testingLogger) Debug() logging.Entry {
//}
//
//func (t testingLogger) Trace() logging.Entry {
//}
//
