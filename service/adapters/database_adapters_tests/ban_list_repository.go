...
import (
	...
	badger "github.com/planetary-social/scuttlego/service/adapters/database_adapters_tests"
	"github.com/planetary-social/scuttlego/service/app/commands"
	"github.com/stretchr/testify/require"
	"testing"
)

func TestBanListRepository_LookupMappingReturnsCorrectErrorWhenMappingDoesNotExist(t *testing.T, ts *badger.TestedSystem) {
...
func TestBanListRepository_CreateFeedMappingInsertsMappingsAndRemoveFeedMappingRemovesMappings(t *testing.T, ts *badger.TestedSystem) {
	ts := di.BuildBadgerTestAdapters(t)
...
func TestBanListRepository_AddInsertsHashesAndRemoveRemovesHashesFromBanList(t *testing.T, ts *badger.TestedSystem) {
	ts := di.BuildBadgerTestAdapters(t)
...
func TestBanListRepository_ContainsFeedCorrectlyLooksUpHashes(t *testing.T, ts *badger.TestedSystem) {
	ts := di.BuildBadgerTestAdapters(t)
